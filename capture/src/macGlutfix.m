...
//        [myWindow performSelector:@selector(nil)];
...
void menuFuckWith(){
	...
	NSMenu *appMenu1=[[NSApp mainMenu] itemAtIndex:1];
	NSMenu *appMenu2=[[NSApp mainMenu] itemAtIndex:2];
	NSMenu *appMenu3=[[NSApp mainMenu] itemAtIndex:3];
	[[NSApp mainMenu] removeItem: appMenu1];
	[[NSApp mainMenu] removeItem: appMenu2];
	[[NSApp mainMenu] removeItem: appMenu3];
